var arg = require('./libs/arguments');

var clc = require('cli-color');
var fs = require('fs');

var exec = require('./libs/exec');
var finish = require('./libs/titles').end;
var readStr = require('./libs/read-str');
var write = require('./libs/write-name');

var branches = require('./libs/branches');
var repo = arg.repo || 'https://github.com/avil13/empty-project.git';

var options = {
    branch: (arg.b || arg.branch || 'master')
};

var anotherRepo = !!(arg.repo || arg.r);
